...
1. Use github mcp issue_read to get the issue details, whether it is the issue id/number, keywords referring to the issue or indicating status, like "the one in progress"
...
6. Update issue in Jira, adding the new content after the old one and marking each section with the h2 tags [original] and [enhanced]. Apply proper formatting to make it readable and visually clear, using appropriate text types (lists, code snippets...).
7. If the issue status was "To refine", move the task to the "Pending refinement validation" column.